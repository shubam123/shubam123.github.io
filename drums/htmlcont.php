...
<div class="container custom-conatiner">
		<p style="text-align:center;position:absolute;font-size:20px;">Just coz I liked it <i class="fa fa-random"></i></p>
			...
			<div id="container-sequencer" class="container-sequencer collapse">
				<div id="sequencer" class="sequencer">
					<div class="row" data-target-drum="crash">
						<img src="drums/img/crash.png" alt="Crash">
					...
					<div class="row" data-target-drum="hiHat">
						<img src="drums/img/hi-hat.png" alt="Hi hat">
						<label><input type="checkbox"><span></span></label>
						<label><input type="checkbox"><span></span></label>
						<label><input type="checkbox"><span></span></label>
						<label><input type="checkbox"><span></span></label>
					...
					<div class="row" data-target-drum="snare">
						<img src="drums/img/snare.png" alt="Snare">
						<label><input type="checkbox"><span></span></label>
						<label><input type="checkbox"><span></span></label>
						<label><input type="checkbox"><span></span></label>
						<label><input type="checkbox"><span></span></label>
					...
					<div class="row" data-target-drum="rightTom">
						<img src="drums/img/right-tom.png" alt="Right tom">
						<label><input type="checkbox"><span></span></label>
						<label><input type="checkbox"><span></span></label>
						<label><input type="checkbox"><span></span></label>
						<label><input type="checkbox"><span></span></label>
					...
					<div class="row" data-target-drum="leftTom">
						<img src="drums/img/left-tom.png" alt="Left tom">
						<label><input type="checkbox"><span></span></label>
						<label><input type="checkbox"><span></span></label>
						<label><input type="checkbox"><span></span></label>
						<label><input type="checkbox"><span></span></label>
					...
					<div class="row" data-target-drum="floorTom">
						<img src="drums/img/floor-tom.png" alt="Floor tom">
						<label><input type="checkbox"><span></span></label>
						<label><input type="checkbox"><span></span></label>
						<label><input type="checkbox"><span></span></label>
						<label><input type="checkbox"><span></span></label>
					...
					<div class="row" data-target-drum="kick">
						<img src="drums/img/kick.png" alt="Kick">
						<label><input type="checkbox"><span></span></label>
						<label><input type="checkbox"><span></span></label>
						<label><input type="checkbox"><span></span></label>
						<label><input type="checkbox"><span></span></label>
					...
					<div class="sequencer-controls">
						<button id="sequencer-active-btn" class="btn-samp" aria-label="Play"><i class="fa fa-play"></i></button>
						<div class="sequencer-controls-tempo">
							<button id="bpm-decrease-btn" class="btn-samp" aria-label="Decrease bpm"><i class="fa fa-minus"></i></button>
							<input id="bpm-indicator" type="number" min="100" max="300" size="3" value="150" readonly>
							<button id="bpm-increase-btn" class="btn-samp" aria-label="Iecrease bpm"><i class="fa fa-plus"></i></button>
						</div>
					</div>
				</div>
			</div>
		...
		<footer class="demo-footer">
			<div class="container-btns">
				<button class="btn-samp btn-tooltip btn-sequencer" id="sequencer-visible-btn" aria-label="Toggle sequencer"><i class="fa fa-th"></i></button>
				<button class="btn-samp btn-tooltip btn-keys" id="keys-btn" aria-label="Toggle keyboard legend"><i class="fa fa-keyboard-o"></i></button>
			</div>
		</footer>
</div>
		...
		<audio id="Big-Rack-Tom-Audio" preload="auto">
			<source src="drums/mp3/Big-Rack-Tom.mp3" type="audio/mp3">
		</audio>
		<audio id="Crash-Audio" preload="auto">
			<source src="drums/mp3/Crash.mp3" type="audio/mp3">
		</audio>
		<audio id="Floor-Tom-Audio" preload="auto">
			<source src="drums/mp3/Floor-Tom.mp3" type="audio/mp3">
		</audio>
		<audio id="Hi-Hat-Closed-Audio" preload="auto">
			<source src="drums/mp3/Hi-Hat-Closed.mp3" type="audio/mp3">
		</audio>
		<audio id="Kick-Audio" preload="auto">
			<source src="drums/mp3/Kick.mp3" type="audio/mp3">
		</audio>
		<audio id="Small-Rack-Tom-Audio" preload="auto">
			<source src="drums/mp3/Small-Rack-Tom.mp3" type="audio/mp3">
		</audio>
		<audio id="Snare-Audio" preload="auto">
			<source src="drums/mp3/Snare.mp3" type="audio/mp3">
		</audio>
